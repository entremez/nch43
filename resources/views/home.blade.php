...
<main class="flex-auto">
    <div class="px-8 mt-9">
                    <div class="">
                        ...
                        <p class="mt-6 text-base">El funcionamiento es el siguiente: Se deben cambiar los valores entre corchetes de la URL acorde a lo que se desea revisar.</p>
                        <p class="mt-3 text-base">La URL tiene la siguiente forma:</p>
                        <p class="mt-3 text-xl">https://nch43.cl/[lote]/[muestras]/[fila_inidical]/[columna_inicial]</p>
                        <p class="mt-6 text-base">Por lo tanto para recrear los ejemplos N°3 de la norma NCh44 las URL serán:
